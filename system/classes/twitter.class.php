    ...
    function media_info($url)
    {
        ...
        foreach ($query as $key => $value) {
            if (!empty($value) && $value != "undefined") {
                ...
                switch (true) {
                    case (strpos($value, "240") !== false):
                        $video["links"][$i]["quality"] = "144P";
                        break;
                    case (strpos($value, "480") !== false):
                        $video["links"][$i]["quality"] = "480P";
                        break;
                    case (strpos($value, "720") !== false):
                        $video["links"][$i]["quality"] = "720P";
                        break;
                    case (strpos($value, "1080") !== false):
                        $video["links"][$i]["quality"] = "1080P";
                        break;
                }
